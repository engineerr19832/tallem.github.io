document.getElementById('oauthButton').addEventListener('click', function() {
    ...
    const redirectUri = 'https://talleem.github.io/callback'; // Replace with your redirect URI
    ...
    const authUrl = `https://accounts.google.com/o/oauth2/auth?response_type=code&client_id=${clientId}&redirect_uri=${redirectUri}&scope=${encodeURIComponent(scopes)}&access_type=offline`;
