function loadArabicContent(newWindow, events) {
    ...
    if (stopButton) {
     ...
     if (backButton) {
        ...
        backButton.style.fontSize = '48px'; // Minimized font size for button
        backButton.style.textAlign = 'center'; // Horizontally center
        backButton.style.lineHeight = '50px'; // Match the button's height
    }
}
